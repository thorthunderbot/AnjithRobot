...
from platform import python_version #AnjithRobot

from AnjithRobot import (
    ALLOW_EXCL,
    CERT_PATH,
    DONATION_LINK,
    LOGGER,
...
from AnjithRobot.modules import ALL_MODULES
from AnjithRobot.modules.helper_funcs.chat_status import is_user_admin
from AnjithRobot.modules.helper_funcs.misc import paginate_modules
from AnjithRobot.modules.disable import DisableAbleCommandHandler
...
PM_START_TEXT = """
𝐇𝐢 𝐈'𝐦 [✿્᭄͜͡Ꭺ𝗇ʝaℓ🍒](https://te.legra.ph/file/18b5cd1061adfe09f7459.jpg)
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ 𝐀𝐃𝐃 𝐓𝐎 𝐘𝐎𝐔𝐑 𝐆𝐑𝐎𝐔𝐏 ➕️", url="t.me/AnjithRobot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="📣 𝐔𝐏𝐃𝐀𝐓𝐄𝐒", url="https://t.me/Mybotsupport"),
        InlineKeyboardButton(
            text="👥 𝐒𝐔𝐏𝐏𝐎𝐑𝐓", url="https://t.me/BATTLE_GROUP_OF_HEXA"
        ),
    ],
    [
        InlineKeyboardButton(text="📡 𝐍𝐄𝐓𝐖𝐎𝐑𝐊", url="https://t.me/Mybotsupport"),
        InlineKeyboardButton(
            text="💾 𝐑𝐄𝐏𝐎", url="https://t.me/Pokemonmaster856"
        ),
    ],
    [
...
HELP_STRINGS = """
𝐇𝐢 𝐭𝐡𝐞𝐫𝐞, 𝐈'𝐦 *{}*!
𝐂𝐥𝐢𝐤𝐞 𝐁𝐞𝐥𝐨𝐰 𝐓𝐡𝐞 𝐁𝐮𝐭𝐭𝐨𝐧 𝐀𝐧𝐝 𝐆𝐞𝐭 𝐃𝐨𝐜𝐮𝐦𝐚𝐧𝐭𝐚𝐭𝐢𝐨𝐧 𝐎𝐟 𝐌𝐨𝐝𝐮𝐥𝐞𝐬.[.](https://te.legra.ph/file/18b5cd1061adfe09f7459.jpg)
...
HELP_IMG= "https://te.legra.ph/file/18b5cd1061adfe09f7459.jpg"
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        reply_markup=InlineKeyboardMarkup(
                [
                  [
                  InlineKeyboardButton(text=" Support ", url=f"t.me/BATTLE_GROUP_OF_HEXA"),
                  InlineKeyboardButton(text=" Updates ", url=f"t.me/Mybotsupport"),
                  ]
                ]
            ),
        )
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                  ...
                  [
                    InlineKeyboardButton(text="📢 Updates", url="t.me/Mybotsupport"),
                 ],
                 [
                    InlineKeyboardButton(text="⬅ Back", callback_data="zeus_back"),
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@Mybotsupport","[💖 Anjith is back to online 💖](https://te.legra.ph/file/18b5cd1061adfe09f7459.jpg)", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(
