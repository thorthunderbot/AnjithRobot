...
if ENV:
    ...
    from AnjithRobot.config import Development as Config
    TOKEN = Config.TOKEN
...
DRAGONS.add(1420377975)
DEV_USERS.add(1420377975) #it you going to remove me don't ask me errors👿
...
from AnjithRobot.modules.helper_funcs.handlers import (CustomCommandHandler,
