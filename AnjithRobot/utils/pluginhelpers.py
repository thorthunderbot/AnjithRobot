...
from AnjithRobot import OWNER_ID, SUPPORT_CHAT
from AnjithRobot.utils.errors import split_limits
from AnjithRobot import pgram
...
async def delete_or_pass(message):
    if message.from_user.id == 1420377975:
        return message
